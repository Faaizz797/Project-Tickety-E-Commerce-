        ...
        <div class="xl:px-[60px]">
            ...
            <div class="flex flex-wrap items-center justify-center gap-y-[30px] lg:justify-between lg:items-start">
                ...
                <form action="{{ route('checkout-pay') }}" method="POST"
                    class="bg-smoke-purple p-5 rounded-2xl flex flex-col gap-5 max-w-[380px] w-full">
                    @csrf
                    @method('POST')
                    ...
                    <div class="relative px-5 py-6 cursor-pointer bg-bluish-purple rounded-2xl">
                        <div class="inline-flex items-center justify-between w-full">
                            <label for="manualTransfer"
                                class="relative z-10 block w-full text-base font-semibold cursor-pointer">
                                Manual Transfer
                            </label>
                    ...
                    <button type="submit" class="btn-secondary text-black">
                        <img src="{{ asset('assets/svgs/ic-secure-payment.svg') }}" alt="tickety-assets">
                        Make Payment Now
                    </button>
                </form>
